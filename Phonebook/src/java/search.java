...
public class search extends HttpServlet {
  ...
  public void afisare(BD bd, String camp, String valoare) throws Exception {
    ...
    else html+="<p>Nu a fost gasit niciun contact avand informatiile introduse de dumneavostra</p><br><input type = 'submit' name = 'Buton' value = 'Inapoi'>";
    out.println(html);
  }
